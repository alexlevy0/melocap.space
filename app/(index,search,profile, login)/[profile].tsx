...
export function ProfileScreen({ profile }: { profile: string }) {
	...
	const onPress = () => {
		...
		const LogOutButtonIndex = options.length - 2
		...
		showActionSheetWithOptions(
			{
				...
				options,
				cancelButtonIndex,
				destructiveButtonIndex: LogOutButtonIndex,
			},
				...
				options={{
					...
					headerRight: () => (
						<YStack padding="$3" gap="$3">
							<Button onPress={onPress} size="$3" variant="outlined" icon={MoreVertical} />
						</YStack>
					),
				}}
			/>
