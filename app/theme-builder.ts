  ...
  const palettes = {
        ...
        "light": ['hsla(250, 50%, 48%, 1)','hsla(25, 100%, 91%, 0)','hsla(25, 100%, 91%, 0.25)','hsla(25, 100%, 91%, 0.5)','hsla(25, 100%, 91%, 0.75)','hsla(25, 99%, 91%, 1)','hsla(25, 99%, 86%, 1)','hsla(25, 99%, 82%, 1)','hsla(25, 99%, 77%, 1)','hsla(25, 99%, 73%, 1)','hsla(25, 99%, 68%, 1)','hsla(25, 99%, 64%, 1)','hsla(25, 99%, 59%, 1)','hsla(25, 99%, 55%, 1)','hsla(25, 99%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 10%, 1)','hsla(0, 14%, 10%, 0.75)','hsla(0, 14%, 10%, 0.5)','hsla(0, 14%, 10%, 0.25)','hsla(0, 14%, 10%, 0)','hsla(250, 50%, 62%, 1)']
      ,
        "dark": ['hsla(250, 50%, 57%, 1)','hsla(25, 99%, 48%, 0)','hsla(25, 99%, 48%, 0.25)','hsla(25, 99%, 48%, 0.5)','hsla(25, 99%, 48%, 0.75)','hsla(25, 99%, 48%, 1)','hsla(25, 99%, 48%, 1)','hsla(25, 99%, 48%, 1)','hsla(25, 99%, 48%, 1)','hsla(25, 99%, 49%, 1)','hsla(25, 99%, 49%, 1)','hsla(25, 99%, 49%, 1)','hsla(25, 99%, 49%, 1)','hsla(25, 99%, 50%, 1)','hsla(25, 99%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 95%, 1)','hsla(0, 15%, 95%, 0.75)','hsla(0, 15%, 95%, 0.5)','hsla(0, 15%, 95%, 0.25)','hsla(0, 15%, 95%, 0)','hsla(250, 50%, 43%, 1)']
      ,
        "light_accent": ['hsla(25, 99%, 77%, 1)','hsla(250, 50%, 40%, 0)','hsla(250, 50%, 40%, 0.25)','hsla(250, 50%, 40%, 0.5)','hsla(250, 50%, 40%, 0.75)','hsla(250, 50%, 40%, 1)','hsla(250, 50%, 43%, 1)','hsla(250, 50%, 46%, 1)','hsla(250, 50%, 48%, 1)','hsla(250, 50%, 51%, 1)','hsla(250, 50%, 54%, 1)','hsla(250, 50%, 57%, 1)','hsla(250, 50%, 59%, 1)','hsla(250, 50%, 62%, 1)','hsla(250, 50%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(25, 99%, 55%, 1)']
      ,
        "dark_accent": ['hsla(25, 99%, 50%, 1)','hsla(250, 50%, 35%, 0)','hsla(250, 50%, 35%, 0.25)','hsla(250, 50%, 35%, 0.5)','hsla(250, 50%, 35%, 0.75)','hsla(250, 50%, 35%, 1)','hsla(250, 50%, 38%, 1)','hsla(250, 50%, 41%, 1)','hsla(250, 50%, 43%, 1)','hsla(250, 50%, 46%, 1)','hsla(250, 50%, 49%, 1)','hsla(250, 50%, 52%, 1)','hsla(250, 50%, 54%, 1)','hsla(250, 50%, 57%, 1)','hsla(250, 50%, 60%, 1)','hsla(250, 50%, 90%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(25, 99%, 48%, 1)']
